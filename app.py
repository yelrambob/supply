...
# Initialize quantities storage with persistent key
...
with tabs[0]:
    ...
    if catalog.empty:
        ...
        # Apply stored quantities from session state
        ...
        # Use a stable key for the data editor that doesn't change with search
        editor_key = "order_editor_stable"
